...
import com.example.mybanner.OkHttpCallback;
...
public class OkHttpUtil {//个人写的工具类 没有进行封装
    //    public static String BASE_URL = "http://" + MyApplication.getSp().getString("ip", "dasai.sdvcst.edu.cn") +
...
//            }
    ...
    public void doPost() {
        new Thread(new Runnable() {
            ...
            public void run() {
                OkHttpClient okHttpClient = new OkHttpClient.Builder()
                        .readTimeout(5, TimeUnit.SECONDS)
                        .build();
                FormBody formBody = new FormBody.Builder() //post请求声名FormBody对象
                        .add("author", "xx")
        ...
        }).start();//局部创建线程方法new一个线程放入Ruanable 写run方法 最后.start()开启
    }
